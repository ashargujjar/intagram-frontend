...
import type { RequestStatus, SentRequestItem } from "./types";
...
const RequestHistoryCard = ({ requests }: RequestHistoryCardProps) => {
  return (
    <div className="rounded-2xl border border-[#E6EEF5] bg-white/90 shadow-sm p-4 md:p-5">

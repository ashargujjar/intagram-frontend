...
const VerifyAccount = () => {
  ...
  const handleSendToken = async () => {
    ...
    if (backendUrl) {
      try {
        setIsLoading(true);
        const resp = await fetch(`${backendUrl}/sendToken`, {
          method: "POST",
        ...
        if (resp.ok) {
          const msg =
            data?.message ??
            "A verification token was sent to the email linked to your username.";
          setMessage(msg);
          toast.success(msg);
        } else {
          const msg = data?.message || "Failed to send token.";
          setMessage(msg);
          toast.error(msg);
        }
      } catch (err) {
            ...
            <div className="md:col-span-2 bg-gradient-to-b from-[#1E4F7A] to-[#143A5A] text-white p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-white/80 mt-3 leading-relaxed">
                  We'll send a token to the email linked to your username. Use
                  it on the next screen to activate your account.
                </p>
              </div>
              ...
              <div className="mt-8 space-y-3 text-xs text-white/80">
                <div className="flex items-center gap-2">
                  ...
                  Protected sign-in and safe access
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="md:col-span-3 p-8 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    ...
                    <button
                      type="button"
                      onClick={() => navigate("/verify-account/verify")}

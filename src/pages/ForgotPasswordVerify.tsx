...
const ForgotPasswordVerify = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const resp = await fetch(`${backendUrl}/verify-otp`, {
        method: "POST",
          ...
          <div className="grid grid-cols-1 md:grid-cols-5">
            <div className="md:col-span-2 bg-gradient-to-b from-[#1E4F7A] to-[#143A5A] text-white p-8 flex flex-col justify-between">
              <div>
                ...
                <h1 className="text-2xl font-semibold mt-4">Verify OTP</h1>
                <p className="text-sm text-white/80 mt-3 leading-relaxed">
                  Enter the OTP code you received by email to continue.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-[#1E4F7A]"
                  />
                </div>
